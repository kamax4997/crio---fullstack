...
router.route('/admin/createEmailTemplate').post(adminController.createEmailTemplate);
router.route('/admin/updateEmailTemplate').post(adminController.updateEmailTemplate);
router.route('/admin/getAllEmailTemplates').post(adminController.getAllEmailTemplates);
router.route('/admin/getAllEmailTemplatesByName').post(adminController.getAllEmailTemplatesByName);
